    ...
    async function handleSubmit(e) {
        ...
        try {
            if (isLogin) {
                ...
                setIsSuccess(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(t('checkEmail'));
            }
        } catch (error) {
            console.log("Auth error:", error); // Changed to log to avoid Next.js error overlay
            if (error.message.includes("Email not confirmed")) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(t('checkEmail'));
            } else {
...
_s(AuthPage, "PWi3U4aFhBdA/o3a4MDeGpxQgAM=", false, function() {
    return [
...
//# sourceMappingURL=src_036c823f._.js.map